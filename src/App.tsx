...
import { Cpu, Github, Linkedin, Mail, ExternalLink, Code2, Brain, Rocket, Award, ChevronRight } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen font-sans selection:bg-cyber-blue/30">
      ...
      <main className="relative pt-16">
        {/* Hero Section */}
        <section id="about" className="min-h-[90vh] flex flex-col items-center justify-center px-6 relative overflow-hidden">
          ...
          >
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              <a href="#projects" className="px-8 py-4 bg-cyber-blue text-[#020617] font-bold rounded-lg hover:bg-neon-blue transition-all hover:scale-105">
                VIEW PROJECTS
              </a>
